...
update_app = typer.Typer(
    help='Check, download, and apply spurtle self-updates.',
...
def update_check(
    *,
    ...
    """Check whether a newer version of spurtle is available."""
    from spurtle.cli.context import get_services
    from spurtle.operations.update import check_self_update
...
def update_download(
    *,
    ...
    from spurtle.cli.context import get_services
    from spurtle.operations.update import download_self_update
...
def update_apply(
    *,
    ...
    from spurtle.cli.context import get_services
    from spurtle.operations.update import apply_self_update
