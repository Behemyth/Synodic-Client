...
from spurtle.operations.schema import UpdateCheckResult
from spurtle.schema import UpdateState
...
def _make_controller(
    *,
    ...
    with patch('spurtle.application.update_controller.resolve_update_config') as mock_ucfg:
